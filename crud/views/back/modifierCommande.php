...
<link rel="stylesheet" href="../back/css/morris.css" type="text/css"/>
<!-- Graph CSS -->
...
if (isset($_GET['id_com'])){
    ...
    $result=$commandeC->recupererCommande($_GET['id_com']);
...
<tr>
<td>ID</td>
<td><input type="number" name="id_com" id="id" style="border-radius: 12px" required value="<?PHP echo $id_com ?>" ></td>
<td><span id="missid_com"></span></td>
</tr>

<tr>
<td>id_ligne</td>
<td><input type="number" name="id_lig" id="id_ligne" style="border-radius: 12px" required value="<?PHP echo $id_lig ?>" ></td>
<td><span id="missid_ligne"></span></td>
</tr>
<tr>
<td>Date</td>
<td><input type="Date" name="Date" id="Date" style="border-radius: 12px" required value="<?PHP echo $Date ?>" ></td>
<td><span id="missDate"></span></td>
</tr>
<tr>
<td></td>
<td><input type="submit" name="modifier" value="modifier" id="bouton" class="btn btn-primary" style="border-radius: 12px"></td>
</tr>

<tr>
<td></td>
<td><input type="hidden" name="cin_ini" value="<?PHP echo $_GET['id_com'];?>"></td>
</tr>
</table>
</form>
...
if (isset($_POST['modifier'])){
	$commande=new Commande($_POST['id_com'],$_POST['id_lig'],$_POST['Date']);
	$commandeC->modifierCommande($commande,$_POST['cin_ini']);
	echo $_POST['cin_ini'];
	
echo '<script language="Javascript">
           <!--
                 document.location.replace("afficherCommande.php");
           // -->
     </script>';
}
?>
...
var formValid = document.getElementById('bouton');
            ...
            function validation2(event){
                //Si le champ est vide
                if (id_ligne.validity.valueMissing){
                    event.preventDefault();
                    missid_ligne.textContent = 'id_ligne manquant';
                    missid_ligne.style.color = 'red';
                //Si le format de données est incorrect
                }else {
                    
                    missid_ligne.textContent = 'Acceptable';
                        ...
                        <div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
                                    ...
                                    <li id="menu-academico" ><a href="charts.html"><i class="fa fa-bar-chart"></i><span>Charts</span><div class="clearfix"></div></a></li>
                                     <li id="menu-academico" ><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span> Commande</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
