...
if(isset($_POST['tri']))
{
	$listeLignes=$db->query("SELECT * FROM ligne ORDER BY ligne.`quantite` ASC");
}
else if(isset($_POST['tria']))
{
	$listeLignes=$db->query("SELECT * FROM ligne ORDER BY ligne.`quantite` DESC");
	
}
	else $listeLignes=$ligne1C->afficherLignes();
	...
	<div class="crud">
					<form method="post">
						<button type="submit" name="tri" class="btn btn-primary" style="border-radius: 12px">desc</button> 
					  	<button type="submit" name="tria" class="btn btn-primary" style="border-radius: 12px">asc</button>
						</form>
					...
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
							        ...
							        <li id="menu-academico" ><a href="#"><i class="fa fa-file-text-o"></i>  <span>Commandes</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										 <ul id="menu-academico-sub" >
											<li id="menu-academico-avaliacoes" ><a href="afficherCommande.php">afficher</a></li>
											
											

										  </ul>
									 </li>
									<li><a href="#"><i class="fa fa-check-square-o nav_icon"></i><span>Lignes</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
									  <ul>
										<li><a href="afficherLigne.php"> afficher</a></li>
