...
if (isset($_GET['id_ligne'])){
	$ligneC=new LigneC();
    $result=$ligneC->recupererLigne($_GET['id_ligne']);
...
<tr>
<td>ID</td>
<td><input type="number" name="id_ligne" id="id" style="border-radius: 12px" required value="<?PHP echo $id_ligne ?>" ></td>
<td><span id="missid"></span></td>
</tr>

<tr>
<td>quantite</td>
<td><input type="number" name="quantite" id="quantite" style="border-radius: 12px" required value="<?PHP echo $quantite ?>" ></td>
...
<tr>
<td></td>
<td><input type="hidden" name="cin_ini" value="<?PHP echo $_GET['id_ligne'];?>"></td>
</tr>
</table>
</form>
...
if (isset($_POST['modifier'])){
	$ligne=new ligne($_POST['id_ligne'],$_POST['quantite'],$_POST['price'],$_POST['prix_tot']);
	$ligneC->modifierLigne($ligne,$_POST['cin_ini']);
	echo $_POST['cin_ini'];
	
echo '<script language="Javascript">
           <!--
                 document.location.replace("image3.php");
           // -->
     </script>';
}
?>
...
var formValid = document.getElementById('bouton');
            ...
            function validation2(event){
                ...
                //Si le format de données est incorrect
                    ...
                    missquantite.textContent = 'Acceptable';
